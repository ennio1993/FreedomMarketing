...
namespace TheFreedomMarketing.Security
{
    public class JwtAuthenticationAttribute : Attribute, IAuthenticationFilter
    {
        ...
        private static bool ValidateToken(string token, out string username, out string userNameIdentifier)
        {
            username = null;
            ...
            //userNameIdentifier = usernameIdentifierClaim?.Value;
        ...
        protected Task<IPrincipal> AuthenticateJwtToken(string token)
        {
            ...
            if (ValidateToken(token, out username, out userNameIdentifier))
            {
